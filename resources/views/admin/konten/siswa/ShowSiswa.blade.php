@extends('admin.admin')
@section('is_title', 'ShowSiswa')
@section('is_title_konten', 'ShowSiswa' )
@section('is_konten')
<style>
  $black: #071011;
  $white: #fff;
    ...
    <div class="outer-div">
      <div class="inner-div">
        <div class="front">
          ...
          <img src="{{asset('storage/'.$p->foto)}}" alt="" class="front__face-photo">
          <div class="front__text">
            <h3 class="front__text-header">{{$p->nama}}</h3>
            <p class="front__text-para"><i class="fas fa-map-marker-alt front-icons"></i> &nbsp; {{$p->alamat}}</p>
            <p class="front__text-para">{{$p->nisn}} &nbsp;||&nbsp;  {{$p->jk}}</p>
            <p class="front__text-para mx-2 text-break">{{$p->about}}</p>
          </div>
          <div class="social-media-wrapper">
            @forelse($p->kontak as $l)
            
              @if($l->jenis_id == 1)
                <button type="button" class=" btn btn-outline" data-toggle="tooltip" data-placement="top" title="{{$l->deskripsi}}">
